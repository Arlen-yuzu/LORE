...
def load_model(model, model_path, device, optimizer=None, resume=False, 
               lr=None, lr_step=None):
  start_epoch = 0
  
  # checkpoint = torch.load(model_path, map_location=lambda storage, loc: storage) # 原始版本 把权重参数加载到cpu上，无论来源哪里
...
def freeze_model(model, keep_step=None):
